...
const schema = z.object({
    ...
    predio:z.optional(z.string().min(6, {message: 'Ingrese un nombre de predio valido.'})),    
    nombreRegSoc:z.optional(z.string().min(6, {message: 'Ingrese un nombre de régimen social valido.'})),    
    anioFiscal:z.optional(z.coerce.number().min(0, {message:'Ingrese una dato numérico.'})),
    puebloIndigena:z.optional(z.string().min(6, {message: 'Ingrese un nombre de pueblo indigena valido.'})), 
