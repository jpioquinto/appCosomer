...
Route::middleware(['auth:sanctum'])->group(function () {
    ...
    Route::get('/ur/listado', [\App\Http\Controllers\API\URController::class, 'getURs']);    
    Route::get('/perfil/listado', [\App\Http\Controllers\API\PerfilController::class, 'getPerfils']);    
});